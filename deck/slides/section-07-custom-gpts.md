...
<div class="progress-chip">Section 7 of 13</div>
<div class="lesson-no">Custom GPTs</div>
...
<div class="lesson-no">Section 7 · Why custom assistants?</div>

# A Specialized Assistant Has
...
<div class="steps">
<div class="step"><div class="step-n">1</div><div class="step-t">Define the job</div></div>
<div class="step"><div class="step-n">2</div><div class="step-t">Write the instructions</div></div>
<div class="step"><div class="step-n">3</div><div class="step-t">Add knowledge / files</div></div>
<div class="step"><div class="step-n">4</div><div class="step-t">Add examples</div></div>
<div class="step"><div class="step-n">5</div><div class="step-t">Test with real inputs</div></div>
<div class="step"><div class="step-n">6</div><div class="step-t">Improve based on failures</div></div>
</div>
