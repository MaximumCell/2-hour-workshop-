...
<div class="lesson-no">HeyGen</div>

## AI Video Creation

<div class="figure-side logo"><img src="assets/heygen.png" alt="HeyGen" /></div>
...
<div class="uc">Multilingual localization</div>
<div class="uc">Training and educational videos</div>
<div class="uc">Sales videos</div>
<div class="uc">Marketing content</div>
...
```
Stop scrolling past AI. In the next two hours, you're going to use
it, build with it, and learn how to actually make money with it.

Here's the problem — everyone's talking about AI, but most people
still don't know where to start. Too many tools, too much noise,
zero clarity.

This workshop fixes that. You'll learn the mental models that
actually matter, a prompting framework you'll reuse forever, and
how to build a real working app with Claude — live, from a single
sentence.

Here's what that looks like: one plain-English sentence becomes a
working, mobile-friendly app in minutes, not weeks. You'll watch
it happen, live, built from an idea straight out of the chat.

Then we go further — AI video, real automation with n8n, and how
to turn everything you learn into paid work.

Two hours. Nine skills. One session. Register now, and come build
with us.
```
